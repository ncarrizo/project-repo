...
The variables listed below are the means and standard deviations for the body jerk signals from the accelerometer for the time domain.  Each of these variables is a numeric variable.  The unit of measurement is not specified.  Each variable name lists the source (accelerometer), the type of signal (body jerk signal), the domain of the signal (time), the type variable (mean or standard deviation), and the axis (X, Y or Z).
...
The variables listed below are the means and standard deviations for the body jerk signals from the accelerometer for the time domain.  Each of these variables is a numeric variable.  The unit of measurement is not specified.  Each variable name lists the source (gyroscope), the type of signal (body signal), the domain of the signal (time), the type variable (mean or standard deviation), and the axis (X, Y or Z).
...
The variables listed below are the means and standard deviations for the body jerk signals from the gyroscope for the time domain.  Each of these variables is a numeric variable.  The unit of measurement is not specified.  Each variable name lists the source (gyroscope), the type of signal (body jerk signal), the domain of the signal (time), the type variable (mean or standard deviation), and the axis (X, Y or Z).
...
###Variables 33 and 34
The variables listed below are the mean and standard deviation for the magnitude of the body signals from the accelerometer for the time domain.  Each of these variables is a numeric variable.  The unit of measurement is not specified.  Each variable name lists the source (accelerometer), the type of signal measurement (body signal magnitude), the domain of the signal (time), the type variable (mean or standard deviation), and the axis (X, Y or Z).
...
###Variables 35 and 36
The variables listed below are the mean and standard deviation for the magnitude of the gravity signals from the accelerometer for the time domain.  Each of these variables is a numeric variable.  The unit of measurement is not specified.  Each variable name lists the source (accelerometer), the type of signal measurement (gravity signal magnitude), the domain of the signal (time), the type variable (mean or standard deviation), and the axis (X, Y or Z).
...
###Variables 37 and 38
The variables listed below are the mean and standard deviation for the magnitude of the body jerk signals from the accelerometer for the time domain.  Each of these variables is a numeric variable.  The unit of measurement is not specified.  Each variable name lists the source (accelerometer), the type of measurement (body signal magnitude), the domain of the signal (time), the type variable (mean or standard deviation), and the axis (X, Y or Z).
...
###Variables 39 and 40
The variables listed below are the mean and standard deviation for the magnitude of the body signals from the gyroscope for the time domain.  Each of these variables is a numeric variable.  The unit of measurement is not specified.  Each variable name lists the source (gyroscope), the type of measurement (body signal magnitude), the domain of the signal (time), the type variable (mean or standard deviation), and the axis (X, Y or Z).
...
###Variables 41 and 42
The variables listed below are the mean and standard deviation for the magnitude of the body jerk signals from the gyroscope for the time domain.  Each of these variables is a numeric variable.  The unit of measurement is not specified.  Each variable name lists the source (gyroscope), the type of measurement (body jerk signal magnitude), the domain of the signal (time), the type variable (mean or standard deviation), and the axis (X, Y or Z).
...
The variables listed below are the means and standard deviations for the body signals from the accelerometer for the frequency domain.  Each of these variables is a numeric variable.  The unit of measurement is not specified.  Each variable name lists the source (accelerometer), the type of signal (body signal), the domain of the signal (frequency), the type variable (mean or standard deviation), and the axis (X, Y or Z).
...
The variables listed below are the means and standard deviations for the body jerk signals from the accelerometer for the frequency domain.  Each of these variables is a numeric variable.  The unit of measurement is not specified.  Each variable name lists the source (accelerometer), the type of signal (body jerk signal), the domain of the signal (frequency), the type variable (mean or standard deviation), and the axis (X, Y or Z).
...
The variables listed below are the means and standard deviations for the body signals from the gyroscope for the frequency domain.  Each of these variables is a numeric variable.  The unit of measurement is not specified.  Each variable name lists the source (gyroscope), the type of signal (body signal), the domain of the signal (frequency), the type variable (mean or standard deviation), and the axis (X, Y or Z).
...
###Variables 61 and 62
The variables listed below are the mean and standard deviation for the magnitude of the body signals from the accelerometer for the frequency domain.  Each of these variables is a numeric variable.  The unit of measurement is not specified.  Each variable name lists the source (accelerometer), the type of signal measurement (body signal magnitude), the domain of the signal (frequency), the type variable (mean or standard deviation), and the axis (X, Y or Z).
...
###Variable 63 and 64
The variables listed below are the mean and standard deviation for the magnitude of the body jerk signals from the accelerometer for the frequency domain.  Each of these variables is a numeric variable.  The unit of measurement is not specified.  Each variable name lists the source (accelerometer), the type of signal measurement (body jerk signal magnitude), the domain of the signal (frequency), the type variable (mean or standard deviation), and the axis (X, Y or Z).
...
###Variable 65 and 66
The variables listed below are the mean and standard deviation for the magnitude of the body signals from the gyroscope for the frequency domain.  Each of these variables is a numeric variable.  The unit of measurement is not specified.  Each variable name lists the source (gyroscope), the type of signal measurement (body signal magnitude), the domain of the signal (frequency), the type variable (mean or standard deviation), and the axis (X, Y or Z).
...
###Variable 67 and 68
The variables listed below are the mean and standard deviation for the magnitude of the body jerk signals from the gyroscope for the frequency domain.  Each of these variables is a numeric variable.  The unit of measurement is not specified.  Each variable name lists the source (gyroscope), the type of signal measurement (body jerk signal magnitude), the domain of the signal (frequency), the type variable (mean or standard deviation), and the axis (X, Y or Z).
